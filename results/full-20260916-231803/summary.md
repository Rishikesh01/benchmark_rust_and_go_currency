...
Median of 10 runs after 3 warm-ups (profile `full`, started 2026-09-16T23:18:03+05:30). **Bold** is the best in each row; ⚠ means the runs varied by more than 5%. Spread, min/max and p99.9 latency are in `summary.csv`.
