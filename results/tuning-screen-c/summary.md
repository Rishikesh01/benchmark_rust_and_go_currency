...
Median of 3 runs after 1 warm-up (profile `full`, started 2026-09-16T23:02:45+05:30). **Bold** is the best in each row; ⚠ means the runs varied by more than 5%. Spread, min/max and p99.9 latency are in `summary.csv`.
